	...
	IN PFFS_IRP_CONTEXT IrpContext)
{
	...
	__finally
	{
		if (Vcb != NULL && PagingIoResourceAcquired)
		{
		...
		if (Vcb != NULL && MainResourceAcquired)
		{
			ExReleaseResourceForThreadLite(
					&Vcb->MainResource,
					ExGetCurrentResourceThread());
...
*/
	...
	__finally
	{
		if (Fcb != NULL && PagingIoResourceAcquired)
		{
			ExReleaseResourceForThreadLite(
					&Fcb->PagingIoResource,
					ExGetCurrentResourceThread());
		...
		if (Fcb != NULL && MainResourceAcquired)
		{
			ExReleaseResourceForThreadLite(
					&Fcb->MainResource,
					ExGetCurrentResourceThread());
